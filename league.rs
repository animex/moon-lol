...
pub enum ContextualConditionCharacterMChildConditions {
    ...
    ContextualConditionCharacterHasTimeRemainingForAnimation(ContextualConditionCharacterHasTimeRemainingForAnimation),
...
pub enum ContextualRuleMConditions {
    ...
    ContextualConditionBuffCounterSetToZeroAfterLimitReached(ContextualConditionBuffCounterSetToZeroAfterLimitReached),
    ...
    ContextualConditionNumberOfCharactersNearTargetPos(ContextualConditionNumberOfCharactersNearTargetPos),
    ...
    ContextualConditionBuffCounterReachedLimitFromZero(ContextualConditionBuffCounterReachedLimitFromZero),
